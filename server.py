...
# configure SQLite 3 to enforce foreign key constraints 
...
def get_all_users_descending():
    ...
    for user in users:
        ...
        all_users_ll.insert_beginning(data)
...
def get_all_users_ascending():
    ...
    for user in users:
        ...
        all_users_ll.insert_at_end(data)
...
def get_one_blog_post(blog_post_id):
    ...
    bst = binary_search_tree.BinaryTree()
